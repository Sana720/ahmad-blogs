              ...
              <ul className="space-y-4">
                {topPosts.map(post => (
                  <li key={post.id} className="flex items-center gap-3">
                    <img src={post.image || '/public/file.svg'} alt={post.title} className="w-12 h-12 rounded-lg object-cover bg-[#eaf0f6]" />
            ...
            <ul className="space-y-4">
              ...
              {recentBlogs.map(blog => (
                <li key={blog.id} className="flex items-start gap-3 py-2">
                  <img src={blog.image || '/public/file.svg'} alt={blog.title} className="w-12 h-12 rounded-lg object-cover bg-[#eaf0f6] flex-shrink-0" />
