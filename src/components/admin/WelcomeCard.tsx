...
export default function WelcomeCard({ name, stats }: { name: string, stats: { posts: number, subscribers: number } }) {
  return (
    <div className="flex items-center bg-gradient-to-r from-[#eaf0f6] to-[#f7f8fa] rounded-2xl shadow p-6 mb-8">
      <img src="https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=2960&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Welcome" className="w-28 h-28 mr-6 hidden md:block" />
      <div>
